...
package uk.gov.hmrc.mobiletokenproxy.types
...
object ModelTypes {
  ...
  //TODO: Introduce the service validation once the core app is using the new endpoint: mobile-token-proxy/:service
